...
class MapAllDerbrisAzzaz extends StatefulWidget {
  const MapAllDerbrisAzzaz({Key? key}) : super(key: key);

  @override
  State<MapAllDerbrisAzzaz> createState() => _MapAllDerbrisAzzazState();
}

class _MapAllDerbrisAzzazState extends State<MapAllDerbrisAzzaz> {
  ...
  CameraPosition kGooglePlex = const CameraPosition(
    target: LatLng(36.588248, 37.043212), // idleb
    zoom: 13.4746,
  );
